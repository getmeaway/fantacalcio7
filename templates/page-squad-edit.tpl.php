...
<div id='error-modal' class='modal modal-sm' tabindex='-1'style='z-index: 2000' role='dialog' aria-labelledby='errorModalLabel' aria-hidden='true'>
	<div class='modal-dialog'>
		<div class='modal-content'>
			<div class='modal-header'>
				<button type='button' class='close' data-dismiss='modal'
			...
			<div class='modal-footer'>
				<div class="pull-right"><button type='button' class='btn btn-default' data-dismiss='modal'><?php print t("Ok"); ?></button></div>				
			</div>
		</div>
	</div>
</div>
